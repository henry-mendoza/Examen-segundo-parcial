        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abono = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    FechaAbono = table.Column<DateTime>(type: "date", nullable: false),
                    Total = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesPrestamos", x => x.IdDetalle);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clientes_AspNetUsers_IdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Epiracion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleados_AspNetUsers_IdUsuario",
                        column: x => x.IdUsuario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prestamos_DetallesPrestamos_IdDetalle",
                        column: x => x.IdDetalle,
                        principalTable: "DetallesPrestamos",
                        principalColumn: "IdDetalle",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prestamos_Empleados_IdEmpleado",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prestamos_IdDetalle",
                table: "Prestamos",
                column: "IdDetalle");

            migrationBuilder.CreateIndex(
                name: "IX_Prestamos_IdEmpleado",
                table: "Prestamos",
                column: "IdEmpleado");
